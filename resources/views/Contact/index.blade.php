    ...
    <div class="max-w-5xl mx-auto shadow rounded-xl p-6 mt-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="p-6 rounded-lg shadow-inner">
                ...
                <ul class="space-y-3">
                    <li>
                        <span class="font-medium">Name:</span> {{ $admin->name ?? 'Aidul Fetjri' }}
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <a href="mailto:{{ $admin->email ?? 'aidulfetjri5@gmail.com' }}" class="text-blue-500 hover:underline">
                            {{ $admin->email ?? 'aidulfetjri5@gmail.com' }}
                        </a>
                    </li>
                    <li>
                        ...
                        <div class="flex space-x-3 mt-1">
                            ...
                            <a href="https://instagram.com/demza._" target="_blank" class="text-pink-500 hover:underline">Instagram</a>
                        </div>
                    </li>
                </ul>
            </div>
