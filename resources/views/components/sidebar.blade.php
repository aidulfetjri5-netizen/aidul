<div x-data="{ open: false }" class="flex min-h-screen">
  ...
  <div 
    ...
    <!-- Header Sidebar -->
    <div class="d-flex justify-between items-center p-3 border-b bg-light shadow-sm">
    ...
    <div class="flex-1 overflow-y-auto">
      <ul class="nav nav-pills flex-column gap-1 p-3">
        ...
        <li>
          <a href="{{ url('/admin/messages') }}" class="nav-link {{ Request::is('admin/messages') ? 'active' : 'text-dark' }}">
            Messages
          </a>
        </li>
        <li>
